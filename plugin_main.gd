...
const AudioSource = preload("res://addons/vaudio-godot-mono-openal-2d/common/audionodes/AudioSource.cs")
const AudioSource2D = preload("res://addons/vaudio-godot-mono-openal-2d/audionodes/AudioSource2D.cs")
...
const AudioSourceRelative = preload("res://addons/vaudio-godot-mono-openal-2d/audionodes/AudioSourceRelative.cs")
...
func _enter_tree():
	...
	add_custom_type("AudioSource", "Node2D", AudioSource, iconAL)
	add_custom_type("AudioSource2D", "Node2D", AudioSource2D, iconAL)
	...
	add_custom_type("AudioSourceRelative", "Node2D", AudioSourceRelative, iconAL)
...
func _exit_tree():
	...
	remove_custom_type("AudioSource2D")
