...
// Spatialised AL source - see ALSource for the shared base (playback, volume/pitch/streams) and
// ALSourceRelative for a non-spatialised source pinned to the listener.
[Tool]
public partial class ALSource2D : ALSource
{
