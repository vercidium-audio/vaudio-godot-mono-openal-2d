...
public partial class VAWorld
{
    ...
    [
        "rotation", "rotation_degrees", "scale", "skew", "transform",
        "global_position", "global_rotation", "global_rotation_degrees", "global_scale",
    ...
    /// </summary>
    /// <exception cref="ArgumentException">Thrown when worldSize is NaN, Infinity, or less than or equal to (0, 0)</exception>
    [Export]
    public Vector2 Size
    {
        get => _Size;
    ...
    /// <summary>
    /// Editor-only color used to draw the world bounds gizmo in the 2D viewport
    /// </summary>
    [Export]
    ...
    /// <summary>
    /// While playing, mirrors the editor's 2D viewport camera into the debug window's camera - pan
    /// the camera in the editor viewport and the debug window follows, instead of driving the debug
